...
const update_generator_1 = require("@webpack-cli/generators/update-generator");
...
function update(...args) {
    ...
    return modify_config_helper_1.default("update", update_generator_1.default, configFile);
}
